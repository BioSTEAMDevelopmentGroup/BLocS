...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 20:41:45 2021
...
# parameters.remove(set_plant_capacity)
# model_without_pc = bst.Model(lc.lipidcane_sys, 
...
#     set_plant_capacity,
#     np.linspace(
#         set_plant_capacity.distribution.lower.min(),
#         set_plant_capacity.distribution.upper.max(),
#         10,
#     ),
#     xlfile=os.path.join(folder, 'uncertainty_across_plant_cap.xlsx'),
#     notify=True
# )
